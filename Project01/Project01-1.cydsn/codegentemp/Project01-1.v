// ======================================================================
// Project01-1.v generated from TopDesign.cysch
// 11/30/2020 at 17:43
...
module ADC_DelSig_v3_30_2 (
	...
	cy_clock_v1_0
		#(.id("d8af49bb-c2af-4f7f-99c2-85eb75b6e5a9/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("d8af49bb-c2af-4f7f-99c2-85eb75b6e5a9/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("1562500000"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__BUILT_IN_LED_net;
	wire [0:0] tmpFB_0__BUILT_IN_LED_net;
	wire [0:0] tmpIO_0__BUILT_IN_LED_net;
	wire [0:0] tmpINTERRUPT_0__BUILT_IN_LED_net;
	electrical [0:0] tmpSIOVREF__BUILT_IN_LED_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		BUILT_IN_LED
		 (.oe(tmpOE__BUILT_IN_LED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BUILT_IN_LED_net[0:0]}),
		  .io({tmpIO_0__BUILT_IN_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__BUILT_IN_LED_net),
		  .interrupt({tmpINTERRUPT_0__BUILT_IN_LED_net[0:0]}),
		  .annotation({Net_105}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__BUILT_IN_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("b705c75c-c3de-4c4e-9b41-31f38c5c7b50"),
		  .source_clock_id(""),
		  .divisor(0),
    ...
    ADC_DelSig_v3_30_2 ADC_DelSig_1 (
        .aclk(1'b0),
        .eoc(Net_227),
        .mi(1'b0),
        .nVref(Net_229),
	...
	wire [0:0] tmpOE__TEMP_net;
	wire [0:0] tmpFB_0__TEMP_net;
	wire [0:0] tmpIO_0__TEMP_net;
	wire [0:0] tmpINTERRUPT_0__TEMP_net;
	electrical [0:0] tmpSIOVREF__TEMP_net;
	...
	cy_psoc3_pins_v1_10
		...
		TEMP
		 (.oe(tmpOE__TEMP_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__TEMP_net[0:0]}),
		  .analog({Net_224}),
		  .io({tmpIO_0__TEMP_net[0:0]}),
		  .siovref(tmpSIOVREF__TEMP_net),
		  .interrupt({tmpINTERRUPT_0__TEMP_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TEMP_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__EXT_LED_net;
	wire [0:0] tmpFB_0__EXT_LED_net;
	wire [0:0] tmpIO_0__EXT_LED_net;
	wire [0:0] tmpINTERRUPT_0__EXT_LED_net;
	electrical [0:0] tmpSIOVREF__EXT_LED_net;

	cy_psoc3_pins_v1_10
		#(.id("d8fe6a7e-a20f-4550-825f-0d6d1a6b421c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		EXT_LED
		 (.oe(tmpOE__EXT_LED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__EXT_LED_net[0:0]}),
		  .io({tmpIO_0__EXT_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__EXT_LED_net),
		  .interrupt({tmpINTERRUPT_0__EXT_LED_net[0:0]}),
		  .annotation({Net_233}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__EXT_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__INT_ACC_net;
	wire [0:0] tmpIO_0__INT_ACC_net;
	wire [0:0] tmpINTERRUPT_0__INT_ACC_net;
	electrical [0:0] tmpSIOVREF__INT_ACC_net;

	cy_psoc3_pins_v1_10
		#(.id("420a0f3d-9b07-417a-b753-bfe958c3d362"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		INT_ACC
		 (.oe(tmpOE__INT_ACC_net),
		  .y({1'b0}),
		  .fb({Net_242}),
		  .io({tmpIO_0__INT_ACC_net[0:0]}),
		  .siovref(tmpSIOVREF__INT_ACC_net),
		  .interrupt({tmpINTERRUPT_0__INT_ACC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__INT_ACC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
